...
(function () {
  var a,
    ...
    F,
    G = [].slice;
  (q = '<span className="odometer-value"></span>'),
    (n =
      '<span className="odometer-ribbon"><span className="odometer-ribbon-inner">' +
      q +
      "</span></span>"),
    (d =
      '<span className="odometer-digit"><span className="odometer-digit-spacer">8</span><span className="odometer-digit-inner">' +
      n +
      "</span></span>"),
    (g = '<span className="odometer-formatting-mark"></span>'),
    (c = "(,ddd).dd"),
    (h = /^\(?([^)]*)\)?(?:(.)(d+))?$/),
    (i = 30),
    (f = 2e3),
