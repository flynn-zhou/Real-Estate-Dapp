...
import { CreateThree } from "../PageComponents/CreatePage";
...
const update = () => {
  ...
  const retrieveFile = (event) => {
    ...
    reader.onloadend = () => {
      alert("onloadend call back setting");
      setFile(event.target.files[0]);
  ...
  const handleIPFS = async () => {
    ...
    if (file) {
      try {
        ...
        // const signedUrl = `https://chocolate-perfect-dragonfly-557.mypinata.cloud/ipfs/${upload.cid}`;
        //
        // setUrl(signedUrl);
          ...
          <div className="row g-5 ">
            <div className="col-lg-3 offset-1 ml_md--0 ml_sm--0">
              <div className="collection-single-wized banner">
                ...
                <img src={file || showImg} alt="image" />
                <button onClick={() => handleUploadIPFS()}>Upload</button> */}
