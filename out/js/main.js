  ...
  var imJs = {
    ...
    slickActivation: function () {
      $(".slick-activation-01").slick({
        ...
        adaptiveHeight: true,
        prevArrow:
          '<button className="slide-arrow prev-arrow"><i className="feather-arrow-left"></i></button>',
        nextArrow:
          '<button className="slide-arrow next-arrow"><i className="feather-arrow-right"></i></button>',
        responsive: [
          {
            breakpoint: 1124,
            settings: {
          ...
          success: function (data) {
            ...
            if (data.code == false) {
              ...
              _self
                .find(".rn-btn")
                .after(
                  '<div className="error-msg"><p>*' + data.err + "</p></div>"
                );
            } else {
              $(".error-msg").hide();
    ...
    vedioActivation: function (e) {
      $("#play-video").on("click", function (e) {
        ...
        $("#video-overlay").append(
          '<iframe width="60%" height="80%" src="https://www.youtube.com/embed/7e90gBu4pas" frameborder="0" allowFullScreen></iframe>'
        );
      });
