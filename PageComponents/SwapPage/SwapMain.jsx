  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-transparent text-white px-4 sm:px-6 lg:px-8">
      ...
      <p className="max-w-3xl text-center mb-10 text-xl font-normal lg:text-2xl leading-relaxed">
        Swap your tokens effortlessly on the Polygon blockchain using ETH. Our
        platform enables secure and transparent transactions for your real
        estate investments.
      </p>
      <p className="max-w-3xl text-center mb-10 text-xl font-normal lg:text-2xl leading-relaxed">
        ...
        to seamlessly swap your wBTC to BTC and vice-versa, allowing you to
        invest confidently in our tokenized real estate assets.
      </p>
      <p className="max-w-3xl text-center text-white mb-10 text-xl font-normal lg:text-3xl leading-relaxed">
        ETH swaps are coming soon to further enhance your investment options and
