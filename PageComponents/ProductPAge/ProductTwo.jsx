        ...
        <div className="row g-5">
          ...
          >
            <div className="product-style-one no-overlay">
              <div className="card-thumbnail">
                ...
                <div className="countdown" data-date="2024-11-09">
          ...
          >
            <div className="product-style-one no-overlay">
              ...
              <div className="bid-react-area">
                <div className="last-bid">0.450ETH</div>
                <div className="react-area">
                  <svg
                    viewBox="0 0 17 16"
                    fill="none"
          ...
          >
            <div className="product-style-one no-overlay">
              <div className="card-thumbnail">
                ...
                <div className="countdown" data-date="2024-12-09">
                  <div className="countdown-container days">
              ...
              <div className="bid-react-area">
                <div className="last-bid">0.311ETH</div>
                <div className="react-area">
                  <svg
                    viewBox="0 0 17 16"
                    fill="none"
