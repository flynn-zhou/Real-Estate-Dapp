...
import { MyWalletConnect } from "../ConectButtonPage";

const Header = () => {
  // const { activeAccount, CLIENT_BY_ME } = useStateContext();
                  ...
                  <ul className="mainmenu">
                    ...
                    <li>
                      ...
                      <ul className="submenu">
                        ...
                        <li>
                          <a className="live-expo" href="/create">
                            Create
                          </a>
                        </li>
                        <li>
                          <a className="live-expo" href="/author">
                            Author
                          </a>
                        </li>
                        <li>
                    ...
                    <div className="icon-box">
                      ...
                      <div className="rn-dropdown">
                        ...
                        <ul className="list-inner">
                          ...
                          <li>
                            <a href="#" onClick={() => wallet.disconnect()}>
                              Disconnect
                            </a>
                          </li>
                        </ul>
